...
class Document:
    """
    Class responsible for the tracking of a given document within a corpus.

    Utilizes NLTK's Snowball Stemmer for the processing of terms.

    Attributes:
        _title (str): Title of the document
        _words (list[str]): List of all the words (unfiltered and not stemmed) in a document
...
class Corpus:
    ...
    Attributes:
        _docs (list[Document]): List of all documents
        ...
        _tf_idf (dict[str, Vector]): Dictionary of the document title and associated document vector
    """
